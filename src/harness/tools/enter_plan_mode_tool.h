...
/// Read-only tool that enters Plan Mode on the AgentLoop.
/// In Plan Mode, only Read and Network level tools are allowed.
class EnterPlanModeTool : public ITool
{
public:
    explicit EnterPlanModeTool(act::framework::AgentLoop &loop);
